...
contains
    ...
    subroutine initialize_wlcsim_data(wlc_d, wlc_p)
        ...
        wlc_d%Window(1) = WLC_P__NB/5.0_dp
        wlc_d%Window(2) = WLC_P__NB/5.0_dp
        wlc_d%Window(3) = WLC_P__NB/5.0_dp
        wlc_d%Window(4) = 0
        wlc_d%Window(5) = 0
        wlc_d%Window(6) = 0
        wlc_d%Window(7) = WLC_P__NB/5.0_dp
        wlc_d%Window(8) = 0
        wlc_d%Window(9) = 0
        wlc_d%Window(10) = 1
        wlc_d%Window(11) = WLC_P__NB/5.0_dp
    ...
    subroutine printDescription(wlc_p)
        ...
        print*, " persistance length =",(WLC_P__L0/(2.0_dp*WLC_P__EPS))
        ...
        print*, " number of kuhn lengths between beads, eps ", WLC_P__EPS
        print*, " "
        print*, "Energy Variables"
        print*, " elasticity EPS =", WLC_P__EPS
    ...
    subroutine save_parameters(wlc_p,fileName)
        ...
        open (unit =outFileUnit, file = fileName, status = 'NEW')
            ...
            write(outFileUnit,"(f10.5)") (WLC_P__L0/WLC_P__EPS) ! 14 Khun lenth
    ...
    !    Setup the parameters for ssWLC simulation
        ...
        ! WLC_P__L0 = wlc_p%GAM  ! not sure why this was included
        endif
